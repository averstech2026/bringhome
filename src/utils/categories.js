...
const CATEGORY_KEYWORDS = [
  {
    ...
    roots: [
      ...
      'сметан', 'ряжен', 'простокваш', 'сливк', 'бифид',
    ],
  },
  {
  ...
  },
  {
    ...
    roots: [
      ...
      'груш', 'виногра', 'ягод', 'лимон', 'укроп', 'петруш', 'кинз', 'базилик',
      'сельдер', 'шпинат', 'руккол', 'свекл', 'редис', 'баклажан',
      'кабач', 'тыкв', 'имбир', 'клубник', 'малин', 'черник', 'смородин', 'голубик',
    ],
  },
  {
    category: 'Бакалея',
    roots: [
      ...
      'овсян', 'перлов', 'пшён', 'круп', 'масло подс', 'подсолнеч', 'сахар', 'соль', 'уксус',
      'кетчуп', 'майон', 'соус', 'масло слив', 'масло олив', 'яйц',
    ],
  },
  {
    category: 'Напитки',
    roots: ['вода', 'сок', 'лимонад', 'кола', 'чай', 'кофе', 'компот', 'морс', 'пиво', 'квас'],
  },
  {
    category: 'Заморозка',
