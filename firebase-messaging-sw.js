 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Zs(),Zt([{"revision":"3783b356592b41c706e4b195d879ac24","url":"index.html"},{"revision":"488c5fd64ee429cfbdc93f1d0964fce3","url":"404.html"},{"revision":null,"url":"assets/workbox-window.prod.es5-BBnX5xw4.js"},{"revision":null,"url":"assets/index-UZAPqcYU.css"},{"revision":null,"url":"assets/index-8ZBcEYik.js"},{"revision":"7e086f1c3c66391589a29f277dbe5a21","url":"apple-touch-icon.png"},{"revision":"78c24d69f7e66d73d12373935a24d4f0","url":"favicon-32.png"},{"revision":"57d64fa09ac56baf21268715bf377db9","url":"masked-icon.svg"},{"revision":"ef43ad789394c3daad38edf872bd6349","url":"pwa-192x192.png"},{"revision":"3d76f4b6429efaeb9b2d702772c7049a","url":"pwa-512x512-maskable.png"},{"revision":"63a4f452b8447592411b51dfa8112c45","url":"pwa-512x512.png"},{"revision":"d796ffdaca41490cd2b9e25f6adedad7","url":"manifest.webmanifest"}]),Qt(),self.addEventListener("install",()=>self.skipWaiting()),self.addEventListener("activate",t=>t.waitUntil(self.clients.claim()));const Et={apiKey:"AIzaSyA3DPpQ0uE3-gRu2Yxr1ruHD3ZYcGEOr0o",authDomain:"bringhome-af0a3.firebaseapp.com",projectId:"bringhome-af0a3",messagingSenderId:"1064797962119",appId:"1:1064797962119:web:e055d089ab58e99042dd22"};if(Et.projectId){const t=Ke(Et);ti(t)}self.addEventListener("notificationclick",t=>{t.notification.close(),t.waitUntil(self.clients.matchAll({type:"window",includeUncontrolled:!0}).then(e=>{for(const n of e)if("focus"in n)return n.focus();if(self.clients.openWindow)return self.clients.openWindow(self.registration.scope)}))})})();
